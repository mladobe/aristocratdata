...
const products = games.map(game => {
  ...
  features.forEach((feature, idx) => {
    ...
    if (feature.description) {
      attributes.push({
        code: `feature_${idx + 1}_description`,
        type: 'STRING',
